...
fn build_and_link_mlx_c() {
    ...
    // Force macOS deployment target and Metal standard for modern feature support.
    config.define("CMAKE_OSX_DEPLOYMENT_TARGET", "14.0");
    config.define("CMAKE_METAL_STANDARD", "3.0");
    config.define("CMAKE_CXX_FLAGS", "-std=gnu++17 -mmacosx-version-min=14.0");
    config.define("CMAKE_C_FLAGS", "-mmacosx-version-min=14.0");
